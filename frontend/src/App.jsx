...
import { getRecommendations, identifyMachine } from './lib/api'
...
import AppShell, { getPrimaryDestinations, useNavigationLayoutMode } from './components/AppShell'
import {
...
export default function App() {
  ...
  const handleSorenessDismiss = useCallback((trainingBucketId) => {
  ...
  if (userLoading) {
    return (
      <AppShell destinations={[]} showNavigation={false}>
  ...
  return (
    <AppShell destinations={primaryDestinations} showNavigation={showNavigation}>
