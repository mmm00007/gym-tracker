...
const DEFAULT_EQUIPMENT_SEED_ROWS = Object.freeze([
  { name: 'Dips', movement: 'Vertical Press', equipment_type: 'bodyweight', muscle_groups: ['Chest', 'Shoulders', 'Triceps'], exercise_type: 'Push', default_weight: 0, default_reps: 8, notes: 'Lean slightly forward and keep reps controlled', thumbnails: ['https://static.strengthlevel.com/images/exercises/dips/dips-800.avif'], instruction_image: null, source: null },
  { name: 'Pull Ups', movement: 'Vertical Pull', equipment_type: 'bodyweight', muscle_groups: ['Back', 'Biceps'], exercise_type: 'Pull', default_weight: 0, default_reps: 6, notes: 'Start from a dead hang and pull chest toward bar', thumbnails: ['https://static.strengthlevel.com/images/exercises/pull-ups/pull-ups-800.avif'], instruction_image: null, source: null },
  { name: 'Push Ups', movement: 'Horizontal Press', equipment_type: 'bodyweight', muscle_groups: ['Chest', 'Shoulders', 'Triceps', 'Core'], exercise_type: 'Push', default_weight: 0, default_reps: 12, notes: 'Keep a rigid plank line throughout each rep', thumbnails: ['https://static.strengthlevel.com/images/exercises/push-ups/push-ups-800.avif'], instruction_image: null, source: null },
  { name: 'Barbell Curl', movement: 'Elbow Flexion', equipment_type: 'freeweight', muscle_groups: ['Biceps', 'Forearms'], exercise_type: 'Pull', default_weight: 20, default_reps: 10, notes: 'Control the eccentric and avoid torso swing', thumbnails: ['https://static.strengthlevel.com/images/exercises/barbell-curl/barbell-curl-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbel Lateral Raises', movement: 'Lateral Raise', equipment_type: 'freeweight', muscle_groups: ['Shoulders'], exercise_type: 'Push', default_weight: 8, default_reps: 12, notes: 'Raise to shoulder height with soft elbows', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-lateral-raise/dumbbell-lateral-raise-800.avif'], instruction_image: null, source: null },
  { name: 'Romanian Deadlift', movement: 'Hip Hinge', equipment_type: 'freeweight', muscle_groups: ['Hamstrings', 'Glutes', 'Back'], exercise_type: 'Pull', default_weight: 50, default_reps: 8, notes: 'Push hips back and keep spine neutral', thumbnails: ['https://static.strengthlevel.com/images/exercises/romanian-deadlift/romanian-deadlift-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Row', movement: 'Horizontal Pull', equipment_type: 'freeweight', muscle_groups: ['Back', 'Lats', 'Biceps'], exercise_type: 'Pull', default_weight: 20, default_reps: 10, notes: 'Pull elbow toward hip without rotating torso', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-row/dumbbell-row-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Hammer Curl', movement: 'Elbow Flexion', equipment_type: 'freeweight', muscle_groups: ['Biceps', 'Forearms'], exercise_type: 'Pull', default_weight: 12, default_reps: 12, notes: 'Keep wrists neutral and elbows pinned', thumbnails: ['https://static.strengthlevel.com/images/exercises/hammer-curl/hammer-curl-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Romanial Deadlift', movement: 'Hip Hinge', equipment_type: 'freeweight', muscle_groups: ['Hamstrings', 'Glutes', 'Back'], exercise_type: 'Pull', default_weight: 22, default_reps: 10, notes: 'Keep dumbbells close to legs during hinge', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-romanian-deadlift/dumbbell-romanian-deadlift-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Shrug', movement: 'Scapular Elevation', equipment_type: 'freeweight', muscle_groups: ['Shoulders', 'Upper Back'], exercise_type: 'Pull', default_weight: 22, default_reps: 12, notes: 'Elevate shoulders straight up with pause at top', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-shrug/dumbbell-shrug-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Concentration Curl', movement: 'Elbow Flexion', equipment_type: 'freeweight', muscle_groups: ['Biceps'], exercise_type: 'Pull', default_weight: 10, default_reps: 12, notes: 'Squeeze at the top and lower slowly', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-concentration-curl/dumbbell-concentration-curl-800.avif'], instruction_image: null, source: null },
  { name: 'Dumbbell Front Raise', movement: 'Front Raise', equipment_type: 'freeweight', muscle_groups: ['Shoulders'], exercise_type: 'Push', default_weight: 8, default_reps: 12, notes: 'Lift with control and avoid back swing', thumbnails: ['https://static.strengthlevel.com/images/exercises/dumbbell-front-raise/dumbbell-front-raise-800.avif'], instruction_image: null, source: null },
  { name: 'Bodyweight Squat', movement: 'Squat', equipment_type: 'bodyweight', muscle_groups: ['Quadriceps', 'Glutes', 'Core'], exercise_type: 'Legs', default_weight: 0, default_reps: 15, notes: 'Sit between hips and keep heels planted', thumbnails: ['https://static.strengthlevel.com/images/exercises/bodyweight-squat/bodyweight-squat-800.avif'], instruction_image: null, source: null },
  { name: 'Bodyweight Calf Raise', movement: 'Calf Raise', equipment_type: 'bodyweight', muscle_groups: ['Calves'], exercise_type: 'Legs', default_weight: 0, default_reps: 15, notes: 'Pause at peak contraction on each rep', thumbnails: ['https://static.strengthlevel.com/images/exercises/bodyweight-calf-raise/bodyweight-calf-raise-800.avif'], instruction_image: null, source: null },
  { name: 'Glute Bridge', movement: 'Hip Extension', equipment_type: 'bodyweight', muscle_groups: ['Glutes', 'Hamstrings', 'Core'], exercise_type: 'Legs', default_weight: 0, default_reps: 12, notes: 'Drive through heels and keep ribs down', thumbnails: ['https://static.strengthlevel.com/images/exercises/glute-bridge/glute-bridge-800.avif'], instruction_image: null, source: null },
  { name: 'Ab Wheel Rollout', movement: 'Core Anti-Extension', equipment_type: 'other', muscle_groups: ['Core', 'Shoulders'], exercise_type: 'Core', default_weight: 0, default_reps: 8, notes: 'Move slowly and avoid lower back sag', thumbnails: ['https://static.strengthlevel.com/images/exercises/ab-wheel-rollout/ab-wheel-rollout-800.avif'], instruction_image: null, source: null },
  { name: 'Inverted Row', movement: 'Horizontal Pull', equipment_type: 'bodyweight', muscle_groups: ['Back', 'Biceps', 'Core'], exercise_type: 'Pull', default_weight: 0, default_reps: 10, notes: 'Keep body straight and pull chest to bar', thumbnails: ['https://static.strengthlevel.com/images/exercises/inverted-row/inverted-row-800.avif'], instruction_image: null, source: null },
  { name: 'Superman', movement: 'Spinal Extension', equipment_type: 'bodyweight', muscle_groups: ['Back', 'Glutes'], exercise_type: 'Core', default_weight: 0, default_reps: 12, notes: 'Lift limbs together with smooth tempo', thumbnails: ['https://static.strengthlevel.com/images/exercises/superman/superman-800.avif'], instruction_image: null, source: null },
  { name: 'Hanging Leg Raises', movement: 'Hip Flexion', equipment_type: 'bodyweight', muscle_groups: ['Core', 'Hip Flexors'], exercise_type: 'Core', default_weight: 0, default_reps: 10, notes: 'Control swing and raise knees or legs high', thumbnails: ['https://static.strengthlevel.com/images/exercises/hanging-leg-raise/hanging-leg-raise-800.avif'], instruction_image: null, source: null },
  { name: 'Smith Machine Bench Press', movement: 'Horizontal Press', equipment_type: 'machine', muscle_groups: ['Chest', 'Shoulders', 'Triceps'], exercise_type: 'Push', default_weight: 35, default_reps: 8, notes: 'Lower to mid chest and press evenly', thumbnails: ['https://static.strengthlevel.com/images/exercises/smith-machine-bench-press/smith-machine-bench-press-800.avif'], instruction_image: null, source: 'default_catalog' },
  { name: 'Cable Seated Row', movement: 'Horizontal Pull', equipment_type: 'cable', muscle_groups: ['Back', 'Biceps'], exercise_type: 'Pull', default_weight: 30, default_reps: 10, notes: 'Keep chest up and finish elbows by sides', thumbnails: ['https://static.strengthlevel.com/images/exercises/seated-cable-row/seated-cable-row-800.avif'], instruction_image: null, source: null },
  { name: 'Cable Lat Pulldown', movement: 'Vertical Pull', equipment_type: 'cable', muscle_groups: ['Back', 'Biceps'], exercise_type: 'Pull', default_weight: 35, default_reps: 10, notes: 'Pull bar to upper chest with stable torso', thumbnails: ['https://static.strengthlevel.com/images/exercises/lat-pulldown/lat-pulldown-800.avif'], instruction_image: null, source: null },
  { name: 'Cable Tricep Pushdown', movement: 'Elbow Extension', equipment_type: 'cable', muscle_groups: ['Triceps'], exercise_type: 'Push', default_weight: 20, default_reps: 12, notes: 'Keep elbows tucked and lock out softly', thumbnails: ['https://static.strengthlevel.com/images/exercises/tricep-pushdown/tricep-pushdown-800.avif'], instruction_image: null, source: null },
])
...
export async function bootstrapDefaultEquipmentCatalog() {
  ...
  if (seedError.code === '42883') {
    ...
    const fallbackRows = DEFAULT_EQUIPMENT_SEED_ROWS
      ...
      .map((row) => ({
        ...row,
        source: row.equipment_type === 'machine' ? 'default_catalog' : null,
        user_id: user.id,
        created_at: nowIso,
        updated_at: nowIso,
      }))
