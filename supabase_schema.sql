...
begin
  ...
  from (
    values
      ...
      ('Lat Pulldown Machine', 'Vertical Pull', 'machine', array['Back','Biceps']::text[], 'Pull', 40::real, 10, 'Pull to upper chest with stable torso', 'https://static.strengthlevel.com/images/exercises/lat-pulldown/lat-pulldown-800.avif'),
      ('Leg Press Machine', 'Squat', 'machine', array['Quadriceps','Glutes']::text[], 'Legs', 80::real, 10, 'Control depth and avoid locking knees', 'https://static.strengthlevel.com/images/exercises/bodyweight-squat/bodyweight-squat-800.avif'),
